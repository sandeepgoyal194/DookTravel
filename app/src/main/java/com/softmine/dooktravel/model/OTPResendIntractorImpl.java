...
public class OTPResendIntractorImpl implements IOTPResendIntractor {
    @Override
    public void resend(JSONObject jsonObject,final OnOTPResendFinishedListener listener) {
        try {
//            Log.e("DEBUG","REQUEST="+jsonBody.toString());

            String REGISTER_URL= C.BASE_URL+ C.OTPRESEND;
