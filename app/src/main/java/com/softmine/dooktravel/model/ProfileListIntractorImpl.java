...
public class ProfileListIntractorImpl implements IProfileListIntractor {
    @Override
    public void getProfileListResponse(JSONObject jsonObject,final OnGetProfileListFinishedListener listener) {
        try {
//            Log.e("DEBUG","REQUEST="+jsonBody.toString());

            String REGISTER_URL= C.BASE_URL+ C.PROFILE_LIST_METHOD;
