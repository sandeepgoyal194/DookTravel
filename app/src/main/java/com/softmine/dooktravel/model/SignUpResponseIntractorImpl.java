...
public class SignUpResponseIntractorImpl implements ISignUpResponseIntractor{
    @Override
    public void getSignUpResponse(JSONObject jsonObject, final OnSignUpFinishedListener listener) {
        try {
//            Log.e("DEBUG","REQUEST="+jsonBody.toString());

            String REGISTER_URL= C.BASE_URL+C.SIGNUP_METHOD;
