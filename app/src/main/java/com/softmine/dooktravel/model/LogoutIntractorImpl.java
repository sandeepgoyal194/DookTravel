...
public class LogoutIntractorImpl implements ILogoutIntractor {
    @Override
    public void logout(JSONObject jsonObject,final OnLogoutFinishedListener listener) {
        try {
//            Log.e("DEBUG","REQUEST="+jsonBody.toString());

            String REGISTER_URL= C.BASE_URL+ C.LOGOUT;
