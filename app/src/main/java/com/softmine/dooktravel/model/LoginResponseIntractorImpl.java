...
public class LoginResponseIntractorImpl implements ILoginResponseIntractor {

    @Override
    public void getLoginResponse(JSONObject jsonObject, final OnLoginFinishedListener listener) {
        try {
//            Log.e("DEBUG","REQUEST="+jsonBody.toString());

            String REGISTER_URL= C.BASE_URL+C.LOGIN_METHOD;
