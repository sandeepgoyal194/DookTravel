...
public class CustomEditTextForDrawable extends EditText {
    ...
    public CustomEditTextForDrawable (Context context, AttributeSet attrs) {
        super(context, attrs);
        // this Contructure required when you are using this view in xml
    }

    public CustomEditTextForDrawable(Context context, AttributeSet attrs, int defStyle) {
